...
* @route '/data-deletion'
*/
export const dataDeletion = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: dataDeletion.url(options),
    method: 'get',
})

dataDeletion.definition = {
    methods: ["get","head"],
    url: '/data-deletion',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/data-deletion'
*/
dataDeletion.url = (options?: RouteQueryOptions) => {
    return dataDeletion.definition.url + queryParams(options)
}
...
* @route '/data-deletion'
*/
dataDeletion.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: dataDeletion.url(options),
    method: 'get',
})
...
* @route '/data-deletion'
*/
dataDeletion.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: dataDeletion.url(options),
    method: 'head',
})
...
* @route '/data-deletion'
*/
const dataDeletionForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: dataDeletion.url(options),
    method: 'get',
})
...
* @route '/data-deletion'
*/
dataDeletionForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: dataDeletion.url(options),
    method: 'get',
})
...
* @route '/data-deletion'
*/
dataDeletionForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: dataDeletion.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
dataDeletion.form = dataDeletionForm
